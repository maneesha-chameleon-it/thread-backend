...
const admin_middleware_1 = (0, tslib_1.__importDefault)(require("./middlewares/admin.middleware"));
...
class App {
    ...
    initializeRoutes(routes) {
        this.app.use('/api/v1/secure', auth_middleware_1.default);
        this.app.use('/api/v1/secure/admin', admin_middleware_1.default);
